# Generated by Django 4.1.4 on 2023-01-08 06:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("end_interval_date", models.DateField(blank=True, null=True)),
                (
                    "email_id",
                    models.CharField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(
                        ("installments__exact", 0), ("invoice_interval__exact", 0)
                    ),
                    models.Q(("installments__exact", 0), ("invoice_interval__gt", 0)),
                    models.Q(("installments__gt", 0), ("invoice_interval__exact", 0)),
                    _connector="OR",
                ),
